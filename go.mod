...
require (
	...
	github.com/arangodb-managed/apis v0.72.5-0.20211210151151-3afc87acb6d8
...
replace github.com/arangodb/kube-arangodb => github.com/arangodb/kube-arangodb v0.0.0-20211022082224-cd387f98ed09
