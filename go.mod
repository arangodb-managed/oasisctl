...
require (
	...
	github.com/arangodb-managed/apis v0.77.0
...
replace k8s.io/code-generator => k8s.io/code-generator v0.23.14

replace k8s.io/component-base => k8s.io/component-base v0.23.14

replace k8s.io/kubernetes => k8s.io/kubernetes v1.23.14
...
replace github.com/arangodb/kube-arangodb => github.com/arangodb/kube-arangodb v0.0.0-20221025115724-28088875ee61
...
replace github.com/cilium/cilium => github.com/cilium/cilium v1.11.3
...
replace k8s.io/cri-api => k8s.io/cri-api v0.23.14
...
replace github.com/nats-io/nats.go => github.com/nats-io/nats.go v1.20.0
...
replace k8s.io/mount-utils => k8s.io/mount-utils v0.23.14
