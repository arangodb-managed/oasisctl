...
func init() {
	...
	cmd.InitCommand(
		...
		func(c *cobra.Command, f *flag.FlagSet) {
			...
			f.BoolVar(&cargs.enablePrivateDNS, "enable-private-dns", false, "Enable private DNS for the deployment (applicable for AWS and GKE only)")
			...
			c.Run = func(c *cobra.Command, args []string) {
				...
				pes := &network.PrivateEndpointService{
					...
					EnablePrivateDns:  cargs.enablePrivateDNS,
